...
DEFAULT_RAW_DIR = '/home/feng/code/MetaDialog-master/ACE2005data/'  # acl20 data
DEFAULT_DATA_DIR =  '/home/feng/code/MetaDialog-master/ACE2005data/'  # acl20 data
BERT_BASE_UNCASED = '/home/feng/code/MetaDialog-master/bert-base-uncased/'
BERT_BASE_UNCASED_VOCAB = '/home/feng/code/MetaDialog-master/bert-base-uncased/vocab.txt'
...
def basic_args(parser):
    ...
    group.add_argument('--train_path', 
                                                default = "/home/feng/code/MetaDialog-master/ACE2005data/xval_D-trigger_shot_5/D-trigger-train-1-shot-5.json",
                                                required=False, help='the path to the training file.')
    group.add_argument('--dev_path',
                                                default = "/home/feng/code/MetaDialog-master/ACE2005data/xval_D-trigger_shot_5/D-trigger-valid-1-shot-5.json",
                                                required=False, help='the path to the validation file.')
    group.add_argument('--test_path', 
                                                default = '/home/feng/code/MetaDialog-master/ACE2005data/xval_D-trigger_shot_5/D-trigger-test-1-shot-5.json',
                                                required=False, help='the path to the testing file.')
    ...
    group.add_argument("--embedding_cache", type=str, default='/home/feng/code/MetaDialog-master/word_vectors_cache',
    ...
    parser.add_argument("--task", default='sl', choices=['sl', 'sc'],
    ...
    group.add_argument('--n_way', type=int, default=1, help="N-way")
    group.add_argument('--k_shot', type=int, default=1, help="K-shot")
    group.add_argument('--query', type=int, default=1, help="query number")
...
def preprocess_args(parser):
    ...
    group.add_argument("--sim_annotation", default='attention', type=str,
...
def train_args(parser):
    ...
    group.add_argument("--cpt_per_epoch", default=1, type=int, help="The num of check points of each epoch")
    ...
    group.add_argument("--num_train_epochs", default=1, type=float,
    ...
    group.add_argument("--eval_when_train", default=True, action='store_true',
                       help="Test model found new best model")
    group.add_argument("--inter_loss", default=0, type=float,
                       help="add the new inter loss")
    ...
    group.add_argument('--loss_scale', type=float, default=64,
    ...
    group.add_argument('--decay_epoch_size', type=int, default=3,
    ...
    group.add_argument("--no_embedder_grad", default=False, help="not perform grad on embedder")
...
def model_args(parser):
    ...
    group.add_argument("--gcn_layers", default=1, type=int,help="set gcn layer")                    
    group.add_argument("--gcn_emb", default=200, type=int,help="set gcn outpur embedding dim")           
    ...
    group.add_argument("--emb_dim", default=768, type=int, help="Embedding dimension for baseline")
    group.add_argument("--label_reps", default='sep', type=str,
                       choices=['cat', 'sep', 'sep_sum'], help="Method to represent label")
    group.add_argument("--use_schema", default=True, 
                       help="(For MNet) Divide emission by each tag's token num in support set")
    group.add_argument("--gcns", default=0, type=int,help="add gcn or not")
    ...
    group.add_argument("--emission", default='proto', type=str,
                       choices=['mnet', 'rank', 'proto', 'proto_with_label', 'tapnet','proto_with_AttGRU','proto_cross_attention','tapnet_cross','proto_feature',"Min","feature_Min"],
    ...
    group.add_argument("--tap_random_init_r", default=0.5, type=float,
    ...
    group.add_argument("--tap_proto", default=True, action='store_true',
                       help="choose use proto or label in projection space in tap-net method")
    group.add_argument("--tap_proto_r", default=0.3, type=float,
