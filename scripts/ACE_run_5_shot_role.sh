...
echo log file path  /home/feng/code/MetaEE-master/trigger_result/
...
# ======= dataset setting ======
dataset_lst=(trigger_5)
support_shots_lst=(1)  # 5-shot
# data_batch_size=20
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                ...
                                                                CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                    ...
                                                                    ${mask_trans}  >  /home/feng/code/MetaEE-master/trigger_result/${model_name}.DATA.${file_mark}.log
                                                                echo [CLI]
                                                                echo Model: ${model_name}
                                                                echo Task:  ${file_mark}
                                                                echo [CLI]
