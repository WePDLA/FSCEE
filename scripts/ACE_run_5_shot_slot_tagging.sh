...
echo log file path  /home/feng/code/MetaEE-master/Ftrigger_result/
...
test_batch_size=1
#grad_acc=2
grad_acc=1  # if the GPU-memory is not enough, use bigger gradient accumulate  
epoch=5
...
bert_base_uncased=/home/feng/model/bert-base-uncased/
bert_base_uncased_vocab=/home/feng/model/bert-base-uncased/vocab.txt
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    ...
                                                                    CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                        ...
                                                                        ${mask_trans}  >  /home/feng/code/MetaEE-master/Ftrigger_result/${model_name}.DATA.${file_mark}.log
                                                                    echo [CLI]
                                                                    echo Model: ${model_name}
                                                                    echo Task:  ${file_mark}
                                                                    echo [CLI]
