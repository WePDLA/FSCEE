...
echo log file path  /home/feng/code/MetaEE-master/role_result/
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    ...
                                                                    CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                        ...
                                                                        ${mask_trans}  >  /home/feng/code/MetaEE-master/role_result/${model_name}.DATA.${file_mark}.log
                                                                    echo [CLI]
                                                                    echo Model: ${model_name}
                                                                    echo Task:  ${file_mark}
                                                                    echo [CLI]
