...
echo log file path  /home/feng/code/MetaEE-master/zh_result/
...
test_batch_size=1
#grad_acc=2
grad_acc=2  # if the GPU-memory is not enough, use bigger gradient accumulate  
epoch=10
...
emission_lst=(proto_feature proto Min feature_Min)
# emission_lst=(tapnet)
# emission_lst=(proto_feature)
inter_loss_lst=(0)
gcns_lst=(0)
...
label_trans_scaler=none  # transition matrix FROM LABEL scaler, such as re-scale the value to non-negative
...
bert_base_uncased=/home/feng/model/chinese-roberta-wwm-ext/
bert_base_uncased_vocab=/home/feng/model/chinese-roberta-wwm-ext/vocab.txt
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    ...
                                                                    CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                        ...
                                                                        ${mask_trans}  >  /home/feng/code/MetaEE-master/zh_result/${model_name}.DATA.${file_mark}.log
                                                                    echo [CLI]
                                                                    echo Model: ${model_name}
                                                                    echo Task:  ${file_mark}
                                                                    echo [CLI]
