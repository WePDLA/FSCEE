#!/usr/bin/env python
import torch
from models.modules.similarity_scorer_base import SimilarityScorerBase, MatchingSimilarityScorer, PrototypeSimilarityScorer,MinSimilarityScorer,FeatureMinSimilarityScorer,PrototypeFeatureSimilarityScorer,ProtowithAttGCNSimilarityScorer, ProtoWithLabelSimilarityScorer,ProtowithCrossSimilarityScorer,TapNetSimilarityScorer,TapNetCrossSimilarityScorer
...
class PrototypeEmissionScorer(EmissionScorerBase):
    ...
    def get_emission(self, similarities: torch.Tensor, support_targets: torch.Tensor):
        ...
        if self.scaler:
            emission = self.scaler(emission, p=3, dim=-1)
        return emission
class MinEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: MinSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(MinEmissionScorer, self).__init__(similarity_scorer, scaler)
    ...
    def get_emission(self, similarities: torch.Tensor, support_targets: torch.Tensor):
        ...
        if self.scaler:
            emission = self.scaler(emission, p=3, dim=-1)
        return emission
class FeatureMinEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: FeatureMinSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(FeatureMinEmissionScorer, self).__init__(similarity_scorer, scaler)
...
class PrototypeFeatureEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: PrototypeFeatureSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(PrototypeFeatureEmissionScorer, self).__init__(similarity_scorer, scaler)
...
class ProtowithAttGCNEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: ProtowithAttGCNSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(ProtowithAttGCNEmissionScorer, self).__init__(similarity_scorer, scaler)
...
class ProtowithCrossEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: ProtowithCrossSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(ProtowithCrossEmissionScorer, self).__init__(similarity_scorer, scaler)
...
class TapNetEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: TapNetSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
...
class TapNetCrossEmissionScorer(EmissionScorerBase):
    def __init__(self, similarity_scorer: TapNetCrossSimilarityScorer, scaler: ScaleControllerBase = None):
        """
        :param similarity_scorer: Module for calculating token similarity
        """
        super(TapNetCrossEmissionScorer, self).__init__(similarity_scorer, scaler)
